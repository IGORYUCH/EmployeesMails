...
namespace EmployeesMails_.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            this.Employee.Add(new Employee { Name = "Username", Surname = "Surname", Department = "Department" });
            this.Employee.Add(new Employee { Name = "Nansy", Surname = "Willer", Department = "it" });
            ...
            this.Mail.Add(new Mail { Name = "I want to eat", Content = "Please let me go to eat. I tired to work without sallary", From_employee = this.Employee.Find(6), To_employee = this.Employee.Find(4), Date = DateTime.Now });
            ...
            this.Mail.Add(new Mail { Name = "Is you weekend free?", Content = "Sorry but i already have a boyfriend((((((((((((((", From_employee = this.Employee.Find(5), To_employee = this.Employee.Find(6), Date = DateTime.Now });
            this.SaveChanges();
        }
    }
